###########################################################################
## Makefile generated for component 'parrot_grabber_keyboard_control'. 
## 
## Makefile     : parrot_grabber_keyboard_control.mk
## Generated on : Tue Jul 13 22:19:32 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/parrot_grabber_keyboard_control.so
...
PRODUCT_NAME              = parrot_grabber_keyboard_control
MAKEFILE                  = parrot_grabber_keyboard_control.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/s2130866/MATLAB/Projects/examples/parrotMinidroneKeyboardControl/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/parrot_grabber_keyboard_control.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/parrot/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/SHARED~1/include -I$(START_DIR)/parrot_grabber_keyboard_control_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
DEFINES_STANDARD = -DMODEL=parrot_grabber_keyboard_control -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = grabberCannon.o MW_TCPSendReceive.o parrot_grabber_keyboard_control.o parrot_grabber_keyboard_control_data.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/shared_linuxservices/src/TCPSendReceive/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/shared_linuxservices/src/TCPSendReceive/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/parrot_grabber_keyboard_control_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/parrot_grabber_keyboard_control_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
grabberCannon.o : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/parrot/src/grabberCannon.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_TCPSendReceive.o : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/shared_linuxservices/src/TCPSendReceive/MW_TCPSendReceive.c
	$(CC) $(CFLAGS) -o "$@" "$<"


parrot_grabber_keyboard_control.o : $(START_DIR)/parrot_grabber_keyboard_control_ert_rtw/parrot_grabber_keyboard_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"


parrot_grabber_keyboard_control_data.o : $(START_DIR)/parrot_grabber_keyboard_control_ert_rtw/parrot_grabber_keyboard_control_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
