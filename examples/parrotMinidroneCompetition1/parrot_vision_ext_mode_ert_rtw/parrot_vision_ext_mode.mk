###########################################################################
## Makefile generated for component 'parrot_vision_ext_mode'. 
## 
## Makefile     : parrot_vision_ext_mode.mk
## Generated on : Mon Jun 07 00:00:32 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/parrot_vision_ext_mode.so
...
PRODUCT_NAME              = parrot_vision_ext_mode
MAKEFILE                  = parrot_vision_ext_mode.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/s2130866/MATLAB/Projects/examples/parrotMinidroneCompetition1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/parrot_vision_ext_mode.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/parrot/include -I$(START_DIR)/parrot_vision_ext_mode_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
DEFINES_STANDARD = -DMODEL=parrot_vision_ext_mode -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rsedu_image.o parrot_vision_ext_mode.o parrot_vision_ext_mode_data.o ext_svr.o updown.o ext_work.o rtiostream_utils.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o rtiostream_interface.o rtiostream_tcpip.o mem_mgr.o
...
%.o : $(START_DIR)/parrot_vision_ext_mode_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/parrot_vision_ext_mode_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
parrot_vision_ext_mode.o : $(START_DIR)/parrot_vision_ext_mode_ert_rtw/parrot_vision_ext_mode.c
	$(CC) $(CFLAGS) -o "$@" "$<"


parrot_vision_ext_mode_data.o : $(START_DIR)/parrot_vision_ext_mode_ert_rtw/parrot_vision_ext_mode_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
