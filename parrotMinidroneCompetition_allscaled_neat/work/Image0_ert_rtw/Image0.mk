###########################################################################
## Makefile generated for component 'Image0'. 
## 
## Makefile     : Image0.mk
## Generated on : Sun Jul 04 11:50:33 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Image0.so
...
START_DIR                 = C:/Users/s2130866/MATLAB/Projects/parrotMinidroneCompetition_allscaled/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Image0.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/parrot/include -I$(START_DIR)/Image0_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/vision/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DR_CHANNEL -DG_CHANNEL -DB_CHANNEL -DY_CHANNEL -DU_CHANNEL -DV_CHANNEL
...
DEFINES_STANDARD = -DMODEL=Image0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rsedu_image.o Image0.o Image0_data.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : $(START_DIR)/Image0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Image0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Image0.o : $(START_DIR)/Image0_ert_rtw/Image0.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Image0_data.o : $(START_DIR)/Image0_ert_rtw/Image0_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
