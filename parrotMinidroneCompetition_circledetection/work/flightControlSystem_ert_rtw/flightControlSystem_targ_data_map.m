  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% dexojrsdjj.fxgka2mnesn.WrapToZero_Threshold_pi33d3guig
	  section.data(1).logicalSrcIdx = 72;
	  section.data(1).dtTransOffset = 0;
	
	  ;% dexojrsdjj.fxgka2mnesn.CompareToConstant_const_gm4kavxnlo
	  ...
	  ;% dexojrsdjj.fxgka2mnesn.DiscreteTimeIntegrator_gainval_jsy4jx3bhc
	  section.data(57).logicalSrcIdx = 176;
	  section.data(57).dtTransOffset = 156;
	
	  ;% dexojrsdjj.fxgka2mnesn.DiscreteTimeIntegrator_IC_ajouoie5d3
	  ...
	  ;% dexojrsdjj.fxgka2mnesn.LPF8HzCutoffFiltertoavoidoscillationsinducedbypositi_cpradlggdz
	  section.data(65).logicalSrcIdx = 184;
	  section.data(65).dtTransOffset = 165;
	
	  ;% dexojrsdjj.fxgka2mnesn.LPF8HzCutoffFiltertoavoidoscillationsinducedbypositi_bkw3yym4od
	  section.data(66).logicalSrcIdx = 185;
	  section.data(66).dtTransOffset = 167;
	
	  ;% dexojrsdjj.fxgka2mnesn.Integrator_gainval_monp5osptd
	  ...
	  ;% dexojrsdjj.fxgka2mnesn.DiscreteTimeIntegrator_gainval_jz0rmjhdkg
	  section.data(72).logicalSrcIdx = 191;
	  section.data(72).dtTransOffset = 173;
	
	  ;% dexojrsdjj.fxgka2mnesn.DiscreteTimeIntegrator_IC_b5khmkd2oo
	  ...
	  ;% dexojrsdjj.fxgka2mnesn.ZeroGain_Gain_lztqi2c1i5
	  section.data(87).logicalSrcIdx = 206;
	  section.data(87).dtTransOffset = 199;
	
	  ;% dexojrsdjj.fxgka2mnesn.Constant1_Value_jmyhpdntn2
	  ...
	  section.data(9).logicalSrcIdx = 238;
	  section.data(9).dtTransOffset = 8;
	  ...
	  ;% dexojrsdjj.fxgka2mnesn.Output_InitialCondition_ojv2zfp1ay
	  section.data(1).logicalSrcIdx = 239;
	  section.data(1).dtTransOffset = 0;
	
	  ;% dexojrsdjj.fxgka2mnesn.FixPtConstant_Value_ctrboznufi
	  section.data(2).logicalSrcIdx = 240;
	  section.data(2).dtTransOffset = 1;
	
	  ;% dexojrsdjj.fxgka2mnesn.Constant_Value_bjqzd5cdbd
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% cjyyyt0pe2y.hjzgjzhprt.LoggedData
	  section.data(1).logicalSrcIdx = 5;
	  section.data(1).dtTransOffset = 0;
	
	  ;% cjyyyt0pe2y.a4cs4o31dy.LoggedData
	  ...
	  ;% cjyyyt0pe2y.fxgka2mnesn.duky3nqigm
	  ...
	  ;% cjyyyt0pe2y.fxgka2mnesn.hnz1nlq3r3
	  ...
	  ;% cjyyyt0pe2y.fxgka2mnesn.pgo0fk3dpf
	  ...
	  ;% cjyyyt0pe2y.fxgka2mnesn.jkcmdznrbo
	  ...
	  ;% cjyyyt0pe2y.fxgka2mnesn.j0guss2zcj
  ...
  targMap.checksum0 = 2442543163;
  targMap.checksum1 = 3716135109;
  targMap.checksum2 = 2697677804;
  targMap.checksum3 = 2263487002;
