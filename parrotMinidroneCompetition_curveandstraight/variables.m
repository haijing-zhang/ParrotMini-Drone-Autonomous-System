...
FOV_CURVE    = 1.6;  %Field of view= 2*(pi/FOV) this is a portion of the circumference
FOV_STRAIGHT = 2.9;

MIN_RADIUS_CROWN_CURVE = 30;
MAX_RADIUS_CROWN_CURVE = 55;

MIN_RADIUS_CROWN_STRAIGHT = 30;
MAX_RADIUS_CROWN_STRAIGHT = 40;
